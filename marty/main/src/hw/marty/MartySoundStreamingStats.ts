...
class MartySoundStreamingStats {
  ...
  private soundStreamingProfiles = [
    new SoundStreamingProfile(64, 44100, true),
  ...
  updateSetup() {
    if (
      this.soundStreamingProfiles[this.currentSoundStreamingProfileIndex].numWarnings >
        this.MAX_WARNING_PER_SETUP &&
